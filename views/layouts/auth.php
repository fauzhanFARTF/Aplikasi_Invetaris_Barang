...
<div class="auth-page">
    <div class="auth-side no-print">
        ...
        <h2>Kelola aset streaming dengan tenang, semua tercatat rapi.</h2>
        <p>SIMASSTA BMN membantu tim Diskominfo Kabupaten Tangerang meminjam, memeriksa, dan merawat peralatan tanpa ribet — cukup beberapa klik.</p>
