        ...
        <table class="table table-sb align-middle" data-testid="checkout-list">
            ...
            <?php foreach ($loans as $l): ?>
                <tr data-ls-row data-ls-text="<?= e(strtolower($l['loan_code'].' '.$l['requester_name'].' '.$l['event_name'])) ?>">
                    ...
                    <td><?php if (role_is('admin_gudang','admin')): ?><a href="<?= BASE_PATH ?>/checkout/<?= e($l["uuid"]) ?>" class="btn btn-sm btn-amber" data-testid="btn-scan-<?= (int)$l['id'] ?>"><i class="fa-solid fa-barcode"></i> Scan</a><?php endif; ?></td>
                </tr>
