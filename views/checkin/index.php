<div class="page-header">
    <div>
        ...
        <p class="subtitle">Terima alat yang dikembalikan & lakukan pengecekan fisik.</p>
    </div>
</div>
...
<div class="card-sb" data-livetable>
    ...
    <div class="table-responsive">
        <table class="table table-sb align-middle" data-testid="checkin-list">
            ...
            <?php foreach ($loans as $l): ?>
                <tr data-ls-row data-ls-text="<?= e(strtolower($l['loan_code'].' '.$l['requester_name'].' '.$l['event_name'])) ?>">
                    ...
                    <td><a href="<?= BASE_PATH ?>/checkin/<?= (int)$l['id'] ?>" class="btn btn-sm btn-amber" data-testid="btn-scan-in-<?= (int)$l['id'] ?>"><i class="fa-solid fa-barcode"></i> Scan</a></td>
                </tr>
